...
public abstract class SafeAsyncTask<ResultT> implements Callable<ResultT> {
  ...
  protected FutureTask<Void> future = new FutureTask<>(newTask());
   ...
   *
   * By default, calls {@link #onException(Exception)}, but this method may be overridden to handle
   * interruptions differently than other exceptions.
   *
  ...
  protected void onException(Exception e) throws RuntimeException {
    Timber.e(e, "Exception caught during background processing");
  }
